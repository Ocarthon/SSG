...
public class Matrix {
    ...
    public Matrix multiply(Matrix m) {
        ...
        mv[0] = v[0] * v[0] + v[1] * v[3] + v[2] * v[6]; // row = 0; col = 0
        mv[1] = v[0] * v[1] + v[1] * v[4] + v[2] * v[7]; // row = 0; col = 1
        mv[2] = v[0] * v[2] + v[1] * v[5] + v[2] * v[8]; // row = 0; col = 2
        mv[3] = v[3] * v[0] + v[4] * v[3] + v[5] * v[6]; // row = 1; col = 0
        mv[4] = v[3] * v[1] + v[4] * v[4] + v[5] * v[7]; // row = 1; col = 1
        mv[5] = v[3] * v[2] + v[4] * v[5] + v[5] * v[8]; // row = 1; col = 2
        mv[6] = v[6] * v[0] + v[7] * v[3] + v[8] * v[6]; // row = 2; col = 0
        mv[7] = v[6] * v[1] + v[7] * v[4] + v[8] * v[7]; // row = 2; col = 1
        mv[8] = v[6] * v[2] + v[7] * v[5] + v[8] * v[8]; // row = 2; col = 2
